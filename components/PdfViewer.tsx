...
export default function PdfViewer() {
  ...
  return (
    <div className="h-full overflow-hidden bg-gray-50 flex flex-col items-center py-4 px-4 font-sans text-gray-800">
      ...
      {/* 狀態 1：還沒上傳 PDF */}
      {!pdfUrl && (
        <div className="w-full max-w-6xl bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6 overflow-hidden">
      ...
      {/* 狀態 2：已上傳 PDF */}
      {pdfUrl && (
        <div className="w-full max-w-6xl flex-1 min-h-0 bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6 overflow-hidden flex flex-col gap-4">
